...
$tinybrowser['path']['image'] = '/uploads_publico/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads_publico/media/'; // Media files location
$tinybrowser['path']['file']  = '/uploads_publico/files/'; // Other files location
