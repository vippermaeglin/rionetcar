...
if ( $_POST ) {
	...
	if ( $flag ) {
		Session::Set('notice', "Template {$template_id} Successfully modified");
	} else {
		Session::Set('error', "Template {$template_id} Failed to Modify");
	}
	redirect(WEB_ROOT . "/vipmin/system/template.php?id={$template_id}");
}
