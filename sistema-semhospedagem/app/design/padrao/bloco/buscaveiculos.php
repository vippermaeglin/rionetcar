...
<?}
	...
	?>
	<div class="secaotitulo popular" style="clear:both;margin-top:11px;margin-bottom:0px;">
		<div style="font-size: 15px;color:#fff; float:left; width: 100%;">Refine a busca do seu veículo pelos filtros acima</span>
	...
	?>
	 ...
	 <?php  
		...
		else if(file_exists(WWW_MOD."/fit.inc")){	
			require(DIR_BLOCO."/bloco_anuncios_home_fit.php"); 
		}
		else{
			require(DIR_BLOCO."/bloco_anuncios_home_normal.php"); 
		}
	 ?>
