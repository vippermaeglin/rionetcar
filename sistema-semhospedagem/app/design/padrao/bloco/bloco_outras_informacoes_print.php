 ...
 <div class="carro-detalhe" style="clear:both;">
	 <div class="span-16 raio-5 last avaliacao fundobranco" style="width:950px;"> 
		<div class="titulocc borda-bottom-1 padding-bottom-10">   
			<div class="span-8 borda-bottom-1 fundosecao" style="width:950px;">
				<div class="alturasecao" style="margin-top:-10px;"> 
						<div class="titfipe">Observações do vendedor
					</div> 
				</div>
			</div>
