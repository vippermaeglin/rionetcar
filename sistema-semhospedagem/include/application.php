...
define('WWW_MOD', rtrim(dirname(DIR_ROOT).'/include/mod'));
define('IMG_ROOT', dirname(DIR_ROOT) . '/media');

define('DIR_DESIGN', dirname(DIR_ROOT) . '/app/design/padrao');
define('DIR_BLOCO', dirname(DIR_ROOT) . '/app/design/padrao/bloco');
