        ...
        <div class="clear box"> 
            <div class="box-content">
				...
				<div class="option_box">
				 ...
				 <div class="left_float"><h4>Slideshow de Banners - Resolução sugerida: 643x x 78px ( jpg, png, gif )</h4></div> 
				...
				<?
					if(file_exists(WWW_MOD."/enterprise.inc")){
						$tipo = "slideshowbannersheader";
					}
					else{
						$tipo = "slideshowbanners";
					}
				?>
					...
					<div class="top-heading group"> <div class="left_float"> </div> </div> 
					 <div id="container_box">
						<div id="option_contents" class="option_contents">  
							<div class="form-contain group"> 
								<div class="text_area">  
									<iframe frameborder="0" style="width:100%;height:200px;" scrolling="auto" src="<?=$ROOTPATH?>/util/swfupload/app/index.php?tipo=<?=$tipo?>"></iframe>
								</div> 
							</div> 
						</div> 
					</div>
				...
				<div  class="option_box">  
						<div class="top-heading group"> <div class="left_float"><h4>Imagens enviadas. Estas imagens irão formar o slideshow de banners</h4> </div> </div> 
						 <div id="container_box">
							<div id="option_contents" class="option_contents">  
								<div class="form-contain group"> 
									<div class="text_area">  
